...
resume_name = '/home1/wjl/trash/data_ATC4/saved/GAMENet/Epoch_47_JA_0.371_DDI_0.1281.model'
...
def eval(model, data_eval, voc_size, epoch):
    ...
    # ddi rate
    ddi_rate = ddi_rate_score(smm_record, path='/home1/wjl/SafeDrug-main/data_ATC4/ddi_A_final_all_v1_1.pkl')
    ddi_pos_rate = ddi_rate_score(smm_record, path='/home1/wjl/SafeDrug-main/data_ATC4/ddi_A_final_pos_new.pkl')
...
def main():
    ...
    data_path = '/home1/wjl/Drug/data_ATC4/records_final_new.pkl'
    voc_path = '/home1/wjl/Drug/data_ATC4/voc_final_new.pkl'

    ehr_adj_path = '/home1/wjl/Drug/data_ATC4/ehr_adj_final_new.pkl'
    
    ddi_adj_path = '/home1/wjl/Drug/data_ATC4/ddi_A_final_all_v1_1.pkl'
    ddi_adj_path_pos = '/home1/wjl/Drug/data_ATC4/ddi_A_final_pos_new.pkl'
    ...
    if args.Test:
        ...
        result = []
        for _ in range(10):
            test_sample = np.random.choice(data_test, round(len(data_test) * 0.001), replace=True)
    ...
    for epoch in range(EPOCH):
        ...
        data_sample = np.random.choice(data_train, round(len(data_train) * 0.1), replace=True)

        for step, input in enumerate(data_sample):
            for idx, adm in enumerate(input):
                ...
                if args.ddi:
                    ...
                    current_ddi_rate = ddi_rate_score([[y_label]], path='/home1/wjl/SafeDrug-main/data_ATC4/ddi_A_final_all_v1_1.pkl')
        ...
        print ()
        tic2 = time.time() 
        ddi_rate, ja, prauc, avg_p, avg_r, avg_f1, avg_med = eval(model, data_sample, voc_size, epoch)
